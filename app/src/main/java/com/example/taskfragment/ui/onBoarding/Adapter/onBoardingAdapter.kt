...
class onBoardingAdapter(private val onStart: () -> Unit) :
    ...
    val data = arrayListOf<onBoard>(
        onBoard(
            "Simple",
            "Description1",
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ43ME1NY04FdIP7gzJu8Bi04Au1t-Ox50qphVwUpmen5nd9YOotwlHBPVIpi6N4kA9HVU&usqp=CAU"
        ),
        onBoard(
            "Convenience",
            "Description2",
        ...
        onBoard(
            "Protected",
            "Description2",
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTxXsjHN7AGQXHs6nrM68gnMPtkttD4Wpxt2U2uCT4kt42RW0f_Pb7L7dwJzdi8Os--d5A&usqp=CAU"
        ),
    ...
    inner class OnBoardingViewHolder(private val binding: ItemOnBoardingBinding) : ViewHolder(
        binding.root
    ) {
